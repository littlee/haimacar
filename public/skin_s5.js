...
function object2vrSkinS5(player, base) {
	var me = this
	var flag = false
	...
	function SkinHotspotClass(skinObj, hotspot) {
		...
		if (hotspot.skinid == 'bxg') {
			...
			this._bxg__img.setAttribute(
				'src',
				basePath + '/images/hotspots/s5/bxg.png'
			)
			this._bxg__img.setAttribute(
				'style',
			...
			this._cclt__img.setAttribute(
				'src',
				basePath + '/images/hotspots/s5/cclt.png'
			)
			this._cclt__img.setAttribute(
				'style',
				'position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;'
			...
			this._ctb__img.setAttribute(
				'src',
				basePath + '/images/hotspots/s5/ctb.png'
			)
			this._ctb__img.setAttribute(
				'style',
				'position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;'
			...
			this._ym__img.setAttribute(
				'src',
				basePath + '/images/hotspots/s5/ym.png'
			)
			this._ym__img.setAttribute(
				'style',
				'position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;'
			...
			this.__div.setAttribute('style', hs)
			this.__div.onclick = function() {
				me.player.openUrl('/?page=detail&product=s5dhb', '')
				me.skin.hotspotProxyClick(me.hotspot.id)
			}
			this.__div.onmouseover = function() {
				me.player.hotspot = me.hotspot
			...
			this._ym__img.setAttribute(
				'src',
				basePath + '/images/hotspots/s5/dhb.png'
			)
			this._ym__img.setAttribute(
				'style',
				'position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;'
